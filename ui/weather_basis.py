    ...
    with col:
        ...
        st.markdown(
            ...
            <div style="
                ...
                margin-bottom:14px;
            ">
                <div style="font-weight:900;font-size:1.05rem;color:#12355b;margin-bottom:8px;">
                    Powered by PVGIS
                </div>
        ...
        # SECONDARY: WEATHER MODEL
        c1, c2, c3 = st.columns(3)

        with c1:
            st.markdown(
                """
                <div style="font-weight:800;font-size:1.6rem;line-height:1;">15 years</div>
                <div style="color:#667085;font-size:0.9rem;margin-top:4px;">Historical data</div>
                """,
                unsafe_allow_html=True,
            )
        ...
        with c2:
            st.markdown(
                """
                <div style="font-weight:800;font-size:1.6rem;line-height:1;">TMY</div>
                <div style="color:#667085;font-size:0.9rem;margin-top:4px;">Weather model</div>
                """,
                unsafe_allow_html=True,
            )
        ...
        with c3:
            st.markdown(
                """
                <div style="font-weight:800;font-size:1.6rem;line-height:1;">Jan–Dec</div>
