...
def render_weather_basis():
    ...
    st.markdown(
        ...
        <div style="
            ...
            <div style="
                ...
                Solar radiation dataset: <b>PVGIS-SARAH3</b><br>
                Meteorological base: <b>ERA5-Land & ERA5</b><br>
                Device input source: <b>S4GA light consumption, battery size and solar size</b>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    with c1:
        st.markdown(
            ...
            <div style="
                ...
                <div style="font-size:1.45rem;font-weight:900;color:#1f2937;">15 years</div>
    ...
    with c2:
        st.markdown(
            ...
            <div style="
                ...
                min-height:96px;
                box-shadow:0 2px 10px rgba(16,24,40,0.04);">
                <div style="font-size:1.45rem;font-weight:900;color:#1f2937;">TMY</div>
    ...
    with c3:
        st.markdown(
            ...
            <div style="
                ...
                min-height:96px;
                box-shadow:0 2px 10px rgba(16,24,40,0.04);">
                <div style="font-size:1.45rem;font-weight:900;color:#1f2937;">Jan–Dec</div>
    ...
    st.markdown(
        ...
        <div style="
            ...
            font-size:0.95rem;
            color:#344054;">
            The assessment combines PVGIS long-term solar and meteorological datasets with S4GA device-specific electrical inputs.
        </div>
        """,
        unsafe_allow_html=True,
    )
